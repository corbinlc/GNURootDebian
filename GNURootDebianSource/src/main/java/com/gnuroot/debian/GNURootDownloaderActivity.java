 ...
 */
public class GNURootDownloaderActivity extends Activity implements IDownloaderClient {
    ...
    private GNURootDownloaderActivity mMe;
    ...
    private static final XAPKFile[] xAPKS = {
            new XAPKFile(
                    ...
                    10 // the version of the APK that the file was originally uploaded against
            ),
    };
    ...
    private void initializeDownloadUI() {
        mDownloaderClientStub = DownloaderClientMarshaller.CreateStub
                (this, GNURootDownloaderService.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!expansionFilesDelivered()) {
            ...
            try {
                Intent launchIntent = GNURootDownloaderActivity.this
                        .getIntent();
                Intent intentToLaunchThisActivityFromNotification = new Intent(
                        GNURootDownloaderActivity
                        .this, GNURootDownloaderActivity.this.getClass());
                ...
                int startResult = DownloaderClientMarshaller.startDownloadServiceIfRequired(this,
                        pendingIntent, GNURootDownloaderService.class);
